      ...
      <v-col cols="12" sm="10" md="12">
        <v-card color="background">
          <v-card-text>
            <p></p>
            <v-row justify="center" align="center">
              <h1 class="text">Account aanmaken</h1>
            </v-row>
            <v-row justify="center" align="center">
              <v-col justify="center" cols="12" sm="6" md="3">
                <v-text-field label="Gebruikersnaam"></v-text-field>
                <v-text-field label="Email"></v-text-field>
                <v-text-field label="Email nog een keer"></v-text-field>
                <v-text-field label="Telefoonnummer begeleider"></v-text-field>
                <v-text-field
                  :type="'password'"
                  label="Wachtwoord"
                ></v-text-field>
